...
class GraphIngestionTool:
    ...
    def __init__(self):
        ...
        self.logger.info(f"GraphIngestionTool initialized [component=graph_tool, cypher_server_url={self.cypher_server_url}, data_modeling_server_url={self.data_modeling_server_url}, openai_deployment={openai_config.get('deployment_name')}]" )
